...
<img src="/img/sqlserver/2.PNG" alt="Getting-gz" width="600" height="200"> 

<img src="/img/sqlserver/3.PNG" alt="Getting-gz" width="600" height="200"> 

it will start installing SQL server Rules file on your system which takes some time

<img src="/img/sqlserver/4.PNG" alt="Getting-gz" width="600" height="200"> 
...
<img src="/img/sqlserver/5.PNG" alt="Getting-gz" width="600" height="200"> 

## Instance Configuration
the name and instance ID for instance of SQL server

<img src="/img/sqlserver/6.PNG" alt="Getting-gz" width="600" height="200"> 

SQL Server Browser Startup type Automatic.

<img src="/img/sqlserver/7.PNG" alt="Getting-gz" width="600" height="200"> 
...
<img src="/img/sqlserver/8.PNG" alt="Getting-gz" width="600" height="200"> 

SQL server 2016 installation completed successfully

<img src="/img/sqlserver/9.PNG" alt="Getting-gz" width="600" height="200"> 

  
<img src="/img/sqlserver/10.PNG" alt="Getting-gz" width="600" height="200"> 
...
<img src="/img/sqlserver/11.PNG" alt="Getting-gz" width="600" height="200"> 

Under IP Addresses specify TCP port 1433 tab, Click on Apply and Enable the TCP/IP.

<img src="/img/sqlserver/12.PNG" alt="Getting-gz" width="600" height="200"> 
...
<img src="/img/sqlserver/16.PNG" alt="Getting-gz" width="600" height="200"> 

select True on XPCmdShellEnabled
 
<img src="/img/sqlserver/17.PNG" alt="Getting-gz" width="600" height="200"> 

new login account for other users.

<img src="/img/sqlserver/18.PNG" alt="Getting-gz" width="600" height="200"> 

choosing SQL server authentication for this user
 
<img src="/img/sqlserver/19.PNG" alt="Getting-gz" width="600" height="200"> 
...
<img src="/img/sqlserver/20.PNG" alt="Getting-gz" width="600" height="200"> 

We have successfully accessed the database system of the MSSQL server

<img src="/img/sqlserver/21.PNG" alt="Getting-gz" width="600" height="200"> 
